...
DROP VIEW IF EXISTS `ta_concatenated`;

CREATE VIEW  `ta_concatenated` AS
(
SELECT 
...
LEFT OUTER JOIN ta_page02 on complete_surveys.ID = ta_page02.Survey_Key 
LEFT OUTER JOIN ta_page03 ON complete_surveys.ID = ta_page03.Survey_Key 
LEFT OUTER JOIN ta_page04 ON complete_surveys.ID = ta_page04.Survey_Key 
LEFT OUTER JOIN ta_page05 ON complete_surveys.ID = ta_page05.Survey_Key 
LEFT OUTER JOIN ta_page06 ON complete_surveys.ID = ta_page06.Survey_Key 
LEFT OUTER JOIN ta_page07 ON complete_surveys.ID = ta_page07.Survey_Key 
LEFT OUTER JOIN ta_page08 ON complete_surveys.ID = ta_page08.Survey_Key 
LEFT OUTER JOIN ta_page09 ON complete_surveys.ID = ta_page09.Survey_Key 
LEFT OUTER JOIN ta_page10 ON complete_surveys.ID = ta_page10.Survey_Key 
LEFT OUTER JOIN ta_page11 ON complete_surveys.ID = ta_page11.Survey_Key 
LEFT OUTER JOIN ta_page12 ON complete_surveys.ID = ta_page12.Survey_Key 
LEFT OUTER JOIN ta_page13 ON complete_surveys.ID = ta_page13.Survey_Key 
LEFT OUTER JOIN ta_page14 ON complete_surveys.ID = ta_page14.Survey_Key 
LEFT OUTER JOIN ta_page15 ON complete_surveys.ID = ta_page15.Survey_Key 
WHERE complete_surveys.ID IS NOT NULL AND complete_surveys.instrument = 'Teacher Assistant' 
