...
(
		...
		Q4_other_1 varchar(255) NULL,
		Q4_other_2 varchar(255) NULL,
		Q4_other_3 varchar(255) NULL,
		Q4_radio varchar(50) NULL,
		Q4_other_4 varchar(255) NULL,
		Q5_text varchar(255) NULL,
		Q6_text varchar(255) NULL
);

CREATE TABLE TA_page04
(
		Survey_Key bigint NOT NULL,
		Q7_checkbox_1 varchar(24) NULL,
		Q7_checkbox_2 varchar(24) NULL,
		Q7_checkbox_3 varchar(24) NULL,
		Q7_checkbox_4 varchar(24) NULL,
		Q7_checkbox_5 varchar(24) NULL,
		Q7_checkbox_6 varchar(24) NULL,
		Q7_checkbox_7 varchar(24) NULL,
...
CREATE TABLE TA_page07
(
		Survey_Key bigint NOT NULL,
		Q28_radio varchar(50) NULL,
		Q29_radio varchar(50) NULL,
		Q30_checkbox_1 varchar(24) NULL,
		Q30_checkbox_2 varchar(24) NULL,
		Q30_checkbox_3 varchar(24) NULL,
		Q30_checkbox_4 varchar(24) NULL,
		Q30_other varchar(255) NULL,
		Q30_checkbox_5 varchar(24) NULL,
		...
		Q31_checkbox_6 varchar(24) NULL,
		Q31_checkbox_7 varchar(24) NULL,
		Q31_other varchar(255) NULL
);

CREATE TABLE TA_page08
(
		Survey_Key bigint NOT NULL,
