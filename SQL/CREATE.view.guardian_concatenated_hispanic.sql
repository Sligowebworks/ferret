...
DROP VIEW IF EXISTS guardian_concatenated_hispanic;

CREATE VIEW guardian_concatenated_hispanic AS
(
SELECT
...
AND complete_surveys.ID IN (	235,	279,	280,	282,	283,		286,	287,	288,	289,	290)
);
