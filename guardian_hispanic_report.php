<?php
 require_once('app/application.php');
  ...
  define('TABLE' , 'guardian_concatenated_hispanic');
  define('TOTAL', 10);
  #	~,~`~,~`~,~`
?>
<H2> District of Columbia Pre-Kindergarten Incentive Program</H2>
<H2> Parent/Guardian Interview Schedule (Spanish Language Interviews)</H2>
<H1>Page 3</H1>
<!-- ~,~`~,~`~,~` -->
...
?>
	...
	<OL start="<?php echo $n ; ?>">
		<LI>	<P CLASS="Question" name="Question" STYLE="margin-bottom: 0in">13. What is the household income range? </P>
	</OL>
	</DIV>
<?php
