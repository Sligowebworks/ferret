...
<?php
		...
		$arrQs[30] = '30. The school trips (field trips) taken by your child\'s class. <BR /> [CHECK HERE IF NONE TAKEN]'. gen_option('','checkbox',  'Q30_checkbox', 'NONE TAKEN', '');
